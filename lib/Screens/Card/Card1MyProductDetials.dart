  ...
  Future<void> _showDeleteDialog(int id) async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title:  Center(child: Text(translate('lan.cancelOrder'),style: TextStyle(fontSize: 20),)),
          actionsAlignment: MainAxisAlignment.spaceEvenly,
          actions: <Widget>[
            TextButton(
              child:  Text(translate('lan.sure'),style: TextStyle(color: Colors.red,fontSize: 20)),
              onPressed: () {
                        removeProduct(id);
            ...
            TextButton(
              child:  Text(translate('lan.cancel'),style: TextStyle(color: HomePage.colorGreen,fontSize: 20),),
              onPressed: () {
                              ...
                              return Stack(
                                ...
                                Padding(padding: EdgeInsets.symmetric(horizontal:15,vertical: 8),
                                  child: Container(
                                      ...
                                      padding: EdgeInsets.fromLTRB(lan=='ar'?15:0, 15, lan=='ar'?0:15, 5),
                                  ...
                                  Align(
                                    alignment:lan=='en'? Alignment.topRight:Alignment.topLeft,
                                    child: Padding(
                                      padding: const EdgeInsets.fromLTRB(20, 12, 20, 0),
                                      child: InkWell(
                                          onTap:(){
                                          _showDeleteDialog(allMyCardProducts[index]
                                              .productId);
                              },

                                          child: Icon(Icons.cancel,color: HomePage.colorGreen,)),
                                    ),
                                  )
